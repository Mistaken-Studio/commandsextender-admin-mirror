...
namespace Mistaken.CommandsExtender.Admin.Commands
{
    ...
    internal class WarpCommand : IBetterCommand, IPermissionLocked, IUsageProvider
    {
        ...
        public string[] Usage => new[] { "warp name (or \"list\" to get warp list)", "%player%" };
        ...
        public override string[] Execute(ICommandSender sender, string[] args, out bool success)
        {
            ...
            if (args[0] == "list")
                return new[] { "Warp list:", "heli", "car", "jail", "jail2", "jail3", "jail4", "jail5", "gatea_up", "gatea_bottom", "gateb_up", "escape_up", "079", "checkpoint_lcz_a", "checkpoint_lcz_b", "checkpoint_ez", "shelter" };
            var res = this.ForeachPlayer(args.Length > 1 ? args[1] : Player.Get(sender).Id.ToString(), out var s, (player) =>
            {
        ...
        internal static string[] ExecuteWarp(Player player, string warp)
        {
            switch (warp.ToLower())
            {
                ...
                case "079":
                    {
                        var pos = RoleType.Scp079.GetRandomSpawnProperties().Item1;
                ...
                default:
                    {
                        return new[] { "Unknown warp. Warp list:", "heli", "car", "jail", "jail2", "jail3", "jail4", "jail5", "gatea_up", "gatea_bottom", "gateb_up", "escape_up", "079", "checkpoint_lcz_a", "checkpoint_lcz_b", "checkpoint_ez", "shelter" };
                    }
            }
        }
    }
